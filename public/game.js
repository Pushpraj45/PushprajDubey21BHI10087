...
let currentPlayer = 'A'; // Initially set to Player A

function appendMessage(player, message) {
...
document.getElementById('send-chat').addEventListener('click', () => {
    ...
    if (message) {
        appendMessage(currentPlayer, message);
        chatInput.value = '';
        // Toggle between Player A and Player B
